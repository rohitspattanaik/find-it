insert into public.users (first_name, last_name, email, is_admin)
values
('System', 'Admin', 'sysadmin', false),
('John', 'Doe', 'a@b.c', false),
('Rohit', 'Pattanaik', 'rohit.pattanaik@gmail.com', true);
